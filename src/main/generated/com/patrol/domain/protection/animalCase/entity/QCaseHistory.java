...
public class QCaseHistory extends EntityPathBase<CaseHistory> {
    ...
    private static final long serialVersionUID = 2090658939L;
    ...
    public final EnumPath<com.patrol.domain.protection.animalCase.enums.ContentType> contentType = createEnum("contentType", com.patrol.domain.protection.animalCase.enums.ContentType.class);

    //inherited
    public final DateTimePath<java.time.LocalDateTime> createdAt = _super.createdAt;

    public final EnumPath<com.patrol.domain.protection.animalCase.enums.CaseHistoryStatus> historyStatus = createEnum("historyStatus", com.patrol.domain.protection.animalCase.enums.CaseHistoryStatus.class);
    ...
    public QCaseHistory(Class<? extends CaseHistory> type, PathMetadata metadata, PathInits inits) {
        ...
        this.animalCase = inits.isInitialized("animalCase") ? new QAnimalCase(forProperty("animalCase")) : null;
    }
