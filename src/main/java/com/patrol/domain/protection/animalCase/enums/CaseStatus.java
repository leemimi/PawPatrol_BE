...
public enum CaseStatus {
  ...
  // 구조 후 선택
  SHELTER_WAIT("보호소/병원 연계 대기"), // 구조 후 보호소 연계를 기다리는 상태
  TEMP_PROTECT_WAIT("임시보호 대기"), // 임시보호자를 기다리는 상태
  ...
  public boolean isProtectingStatus() {
    return this == TEMP_PROTECTING || this == SHELTER_PROTECTING;
  }

  public boolean isWaitingStatus() {
    return this == SHELTER_WAIT || this == TEMP_PROTECT_WAIT;
  }
}
