...
public class NaverProvider extends BaseOAuthProvider {

  @Column(name = "naver_provider_id", length = 50)
  private String providerId;

  @Column(name = "naver_email", length = 50)
  private String email;

  @Column(name = "naver_connected")
  private boolean connected = false;

  @Column(name = "naver_connected_at")
  private LocalDateTime connectedAt;

  @Column(name = "naver_modified_at")
